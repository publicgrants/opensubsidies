...
import { Check, Flame, TrendUp, Plus, Confetti, Plant } from "@phosphor-icons/react";
  ...
  return (
    <div className="mb-6">
      <div className="flex items-center gap-2 mb-3">
        <Flame className="size-4 text-orange-500" weight="fill" />
        ...
        {leaders.map((habit) => (
          ...
          >
            ...
            <div className="flex items-center gap-1">
              <Flame className="size-3 text-orange-500" weight="fill" />
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3 sm:gap-4">
        ...
        >
          {isCompleted ? (
            <Check className="size-5 text-white" weight="bold" />
          ) : (
            habit.icon
          )}
        </button>
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1 flex-wrap">
            ...
            {streak > 0 && (
              <div className="flex items-center gap-1">
                <Flame className="size-3.5 text-orange-500" weight="fill" />
      ...
      {habits.length === 0 ? (
        <div className="flex flex-col items-center gap-4 py-16 text-center">
          <div className="size-16 rounded-2xl bg-primary/10 flex items-center justify-center">
            <Plant className="size-8 text-primary" />
          </div>
          <div>
        ...
        <>
          ...
          {allDone && habits.every((h) => h.id) && (
            <div className="flex items-center gap-3 p-4 rounded-2xl bg-primary/5 border border-primary/20 mt-2">
              <Confetti className="size-5 text-primary shrink-0" />
